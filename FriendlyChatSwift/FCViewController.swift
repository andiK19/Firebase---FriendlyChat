...
class FCViewController: UIViewController, UINavigationControllerDelegate, FUIAuthDelegate {
    ...
    func configureDatabase() {
        ...
        //FirebaseApp.configure()
            ref = Database.database().reference()
                //creating a lisiner specify the path where we can to lisen to changes by path the observe method is to know which
